...
public class WechatUserGetInterceptor implements Interceptor {
	...
	public void intercept(Invocation inv) {
		...
		String nickname = CookieUtils.get(controller, Consts.ATTR_WECHAT_NICKNAME);
		if (StringUtils.areNotBlank(openId, nickname)) {
//			controller.setSessionAttr(Consts.ATTR_WECHAT_OPENID, openId);
			inv.invoke();
			return;
		}
